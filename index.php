...
<html>
 ...
 <br />
  <div class="container box">
   <br />
   <h2 align="center" style="color: blue;">Multi Step Registration Form</h2><br />
   <?php echo $message; ?>
   <form method="post" id="register_form">
    <ul class="nav nav-tabs">
     <li class="nav-item">
      <a class="nav-link active_tab1 bg-danger" style="border:1px solid #ccc; color: red" id="list_login_details"><b>Login Details</b></a>
     </li>
     <li class="nav-item">
      <a class="nav-link inactive_tab1" id="list_personal_details" style="border:1px solid #ccc; color:green"><b>Personal Details</b></a>
     </li>
     <li class="nav-item">
      <a class="nav-link inactive_tab1" id="list_contact_details" style="border:1px solid #ccc; color: blue"><b>Contact Details</b></a>
     </li>
    </ul>
